...
class ReportGenerator:
    ...
    def generate_executive_summary(
        ...
        delay risk, and key recommendations into a concise briefing
        suitable for program directors and stakeholders.
        ...
        sections.append(
            f"<p class='subtitle'>Activities: {act_count} | Generated by MeridianIQ v3.0</p>"
        )
