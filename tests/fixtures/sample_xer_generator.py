...
def generate_sample_xer(output_path: str | Path | None = None) -> Path:
    ...
    add(_tab("%R", "PROJ-001", "Sample Construction", "2024-06-01 08:00", "2024-01-02 08:00", "2024-12-31 17:00", "2024-12-31 17:00", "2024-06-01 08:00"))
    ...
    # ── Active activities (5) ───────────────────────────────
    task_row("T-016", "WBS-030", "CAL-01", "A3050", "Roof Framing", "TT_Task", "TK_Active",
             "0", "0", "40", "80",
             "2024-05-22 08:00", "",
             "2024-05-22 08:00", "2024-06-07 17:00",
             "2024-05-22 08:00", "2024-06-07 17:00",
             "2024-05-22 08:00", "2024-06-04 17:00",
             "2024-05-29 08:00", "2024-06-07 17:00",
             "50", "CP_Drtn", "DT_FixedDrtn",
             fp="1", fpo="14", dpf="Y")

    task_row("T-017", "WBS-030", "CAL-01", "A3060", "MEP Rough-In", "TT_Task", "TK_Active",
             "40", "40", "80", "120",
             "2024-05-22 08:00", "",
             "2024-05-22 08:00", "2024-06-14 17:00",
             "2024-05-27 08:00", "2024-06-21 17:00",
             "2024-05-22 08:00", "2024-06-14 17:00",
             "2024-05-29 08:00", "2024-06-14 17:00",
             "33", "CP_Drtn", "DT_FixedDrtn")

    task_row("T-018", "WBS-030", "CAL-01", "A3070", "Exterior Cladding", "TT_Task", "TK_Active",
             "80", "80", "80", "120",
             "2024-05-15 08:00", "",
             "2024-05-15 08:00", "2024-06-07 17:00",
             "2024-05-29 08:00", "2024-06-21 17:00",
             "2024-05-15 08:00", "2024-06-07 17:00",
             "2024-05-22 08:00", "2024-06-07 17:00",
             "33", "CP_Drtn", "DT_FixedDrtn")

    task_row("T-019", "WBS-031", "CAL-01", "A3080", "Welding Inspection", "TT_Task", "TK_Active",
             "40", "0", "24", "40",
             "2024-05-22 08:00", "",
             "2024-05-22 08:00", "2024-05-28 17:00",
             "2024-05-27 08:00", "2024-06-04 17:00",
             "2024-05-22 08:00", "2024-05-28 17:00",
             "2024-05-22 08:00", "2024-05-28 17:00",
             "60", "CP_Drtn", "DT_FixedDrtn")

    task_row("T-020", "WBS-030", "CAL-01", "A3090", "Fire Protection", "TT_Task", "TK_Active",
             "40", "40", "40", "80",
             "2024-05-22 08:00", "",
             "2024-05-22 08:00", "2024-06-04 17:00",
             "2024-05-29 08:00", "2024-06-11 17:00",
             "2024-05-22 08:00", "2024-06-04 17:00",
             "2024-05-29 08:00", "2024-06-04 17:00",
             "50", "CP_Drtn", "DT_FixedDrtn")

    # ── Not Started activities (10) ─────────────────────────
    task_row("T-021", "WBS-030", "CAL-01", "A4010", "Roof Membrane", "TT_Task", "TK_NotStart",
             "0", "0", "40", "40",
             "", "",
             "2024-06-10 08:00", "2024-06-14 17:00",
             "2024-06-10 08:00", "2024-06-14 17:00",
             "2024-06-10 08:00", "2024-06-14 17:00",
             "2024-06-10 08:00", "2024-06-14 17:00",
    ...
    task_row("T-022", "WBS-030", "CAL-01", "A4020", "Structure Complete", "TT_finmile", "TK_NotStart",
             "0", "0", "0", "0",
             "", "",
    ...
    task_row("T-023", "WBS-041", "CAL-01", "A5010", "Interior Painting", "TT_Task", "TK_NotStart",
             "0", "0", "80", "80",
             "", "",
    ...
    task_row("T-024", "WBS-041", "CAL-01", "A5020", "Flooring", "TT_Task", "TK_NotStart",
             "0", "0", "80", "80",
             "", "",
             "2024-07-01 08:00", "2024-07-12 17:00",
             "2024-07-01 08:00", "2024-07-12 17:00",
             "2024-07-01 08:00", "2024-07-12 17:00",
             "2024-07-01 08:00", "2024-07-12 17:00",
             "0", "CP_Drtn", "DT_FixedDrtn",
    ...
    task_row("T-027", "WBS-050", "CAL-01", "A6010", "Final Inspection", "TT_Task", "TK_NotStart",
             "0", "0", "40", "40",
             "", "",
             "2024-07-15 08:00", "2024-07-19 17:00",
             "2024-07-15 08:00", "2024-07-19 17:00",
             "2024-07-15 08:00", "2024-07-19 17:00",
             "2024-07-15 08:00", "2024-07-19 17:00",
             "0", "CP_Drtn", "DT_FixedDrtn",
    ...
    task_row("T-028", "WBS-050", "CAL-01", "A6020", "Punch List", "TT_Task", "TK_NotStart",
             "0", "0", "80", "80",
             "", "",
             "2024-07-22 08:00", "2024-08-02 17:00",
             "2024-07-22 08:00", "2024-08-02 17:00",
             "2024-07-22 08:00", "2024-08-02 17:00",
             "2024-07-22 08:00", "2024-08-02 17:00",
             "0", "CP_Drtn", "DT_FixedDrtn",
    ...
    task_row("T-029", "WBS-010", "CAL-01", "A1040", "Funding Approval", "TT_mile", "TK_NotStart",
             "160", "160", "0", "0",
             "", "",
             "2024-06-10 08:00", "2024-06-10 08:00",
    ...
    task_row("T-030", "WBS-050", "CAL-01", "A6030", "Project Completion", "TT_mile", "TK_NotStart",
             "0", "0", "0", "0",
             "", "",
             "2024-08-05 08:00", "2024-08-05 08:00",
             "2024-08-05 08:00", "2024-08-05 08:00",
             "2024-08-05 08:00", "2024-08-05 08:00",
             "2024-08-05 08:00", "2024-08-05 08:00",
             "0", "CP_Drtn", "DT_FixedDrtn",
