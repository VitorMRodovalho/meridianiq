...
| Forensic Analyst (claim prep) | Analysis Workflow → Compare → TIA → Narrative |
| Cost Engineer | Cost Integration → EVM → S-Curve |
| Program Director | Getting Started → Programs + Trends (in Analysis Workflow) |
