...
Generated from `src/api/app.py` — **110 endpoints** across **20 routers**. Interactive Swagger UI is served at `/docs` when the API is running; this document is a static browseable index.
...
- [Forensics](#forensics) — 8 endpoints
- [TIA](#tia) — 4 endpoints
- [EVM](#evm) — 6 endpoints
