...
As of **v4.3.0** (Z-shape consolidation — Cycle 5 close per ADR-0024; Cycle 6 W3 wave 4 in-flight): 48 analysis engines + 1 export module, 134 API endpoints across 26 routers, 55 SvelteKit pages, 11 hand-crafted SVG chart components, 33 Supabase migrations, 22 MCP tools, 15 PDF report types, 1687 tests.
...
graph TB
    ...
    subgraph "Platform — Supabase"
        ...
        DB[("PostgreSQL<br/>33 migrations · RLS enforced<br/>projects (pending/ready/failed)<br/>activities · WBS · revision_history<br/>revision_skip_log · audit_log<br/>schedule_derived_artifacts · erp_sources<br/>cbs_elements · cost_snapshots")]
