...
- **API**: FastAPI with 130 endpoints under `/api/v1/` across 26 routers, rate-limited critical endpoints
...
- **Database**: Supabase PostgreSQL with RLS, 31 migrations in `supabase/migrations/`
