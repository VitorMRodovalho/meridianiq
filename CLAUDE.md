...
- **44 analysis engines** in `src/analytics/` + 1 export module in `src/export/` — each standalone, no cross-dependencies
- **API**: FastAPI with 111 endpoints under `/api/v1/` across 20 routers, rate-limited critical endpoints
