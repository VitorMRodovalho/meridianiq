...
## Upstream Project
This project builds upon concepts from [Xer-Reader-PowerBI](https://github.com/djouallah/Xer-Reader-PowerBI) by djouallah (Mimoune). See [ATTRIBUTION.md](ATTRIBUTION.md) for details.
...
- PMI -- Practice Standard for Scheduling, Practice Standard for EVM
