...
<div class="p-8 max-w-3xl mx-auto">
	<h1 class="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-8">Account Settings</h1>
	...
	{:else}
		...
		<div class="bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-700 p-6 mb-6">
			<h2 class="text-sm font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wide mb-4">Profile</h2>
		...
		<!-- Usage Stats -->
		<div class="bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-700 p-6 mb-6">
			<h2 class="text-sm font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wide mb-4">Usage</h2>
			{#if statsLoaded}
				<div class="grid grid-cols-2 gap-6">
					<div>
						<p class="text-3xl font-bold text-gray-900 dark:text-gray-100">{stats.projects}</p>
						<p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Uploaded Schedules</p>
					</div>
					<div>
						<p class="text-3xl font-bold text-gray-900 dark:text-gray-100">{stats.programs}</p>
						<p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Programs</p>
					</div>
				</div>
			{:else}
		...
		<!-- Account Info -->
		<div class="bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-700 p-6 mb-6">
			<h2 class="text-sm font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wide mb-4">Account Details</h2>
			<dl class="space-y-4 text-sm">
				...
				<div class="flex justify-between">
					<dt class="text-gray-500 dark:text-gray-400">Auth Provider</dt>
					<dd class="text-gray-900 dark:text-gray-100">{getProvider($user)}</dd>
				</div>
				<div class="flex justify-between">
					<dt class="text-gray-500 dark:text-gray-400">Last Sign In</dt>
					<dd class="text-gray-900 dark:text-gray-100">{formatDate($user.last_sign_in_at)}</dd>
				</div>
			</dl>
		</div>
		...
		<div class="bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
			<h2 class="text-sm font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wide mb-4">Data & Privacy</h2>
