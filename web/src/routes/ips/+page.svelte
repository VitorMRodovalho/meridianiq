...
<div class="p-8 max-w-6xl mx-auto">
	<div class="mb-8">
		<h1 class="text-2xl font-bold text-gray-900 dark:text-gray-100">IPS Reconciliation</h1>
		...
		<div class="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg p-6 mb-8">
			...
			{:else}
				<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
					<div>
						<label class="block">
							<span class="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2 block">Master Schedule</span>
					...
					<div>
						<span class="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2 block">Sub-Schedules ({subProjectIds.length} selected)</span>
		...
		{#if result}
			...
			<div class="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-8">
				<div class="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg p-4 text-center">
					...
					<p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Alignment Score</p>
				</div>
				<div class="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg p-4 text-center">
					<p class="text-3xl font-bold text-gray-900 dark:text-gray-100">{result.sub_count}</p>
					<p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Sub-Schedules</p>
				</div>
				<div class="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg p-4 text-center">
				...
				<div class="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg mb-6">
					<div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between">
						<div>
							...
							<p class="text-xs text-gray-500 dark:text-gray-400">{sub.sub_activity_count} activities &middot; {sub.matched_milestones} milestones matched &middot; {sub.issues.length} issues</p>
						</div>
							...
							<table class="min-w-full divide-y divide-gray-200 text-sm">
								<thead class="bg-gray-50 dark:bg-gray-800">
									<tr>
										...
										<th class="px-4 py-2 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase">Delta</th>
									</tr>
								</thead>
