...
<main class="max-w-7xl mx-auto px-4 py-8">
	<div class="mb-8">
		<h1 class="text-2xl font-bold text-gray-900">4D Visualization</h1>
		<p class="text-gray-500 mt-1">WBS spatial grouping x CPM temporal positioning</p>
	</div>
	...
	{#if viz}
		...
		<div class="bg-white rounded-lg border border-gray-200 p-6 mt-6">
			<h2 class="text-lg font-semibold text-gray-900 mb-3">WBS Groups</h2>
			<div class="grid grid-cols-2 md:grid-cols-4 gap-3">
				{#each viz.wbs_groups as group}
					<div class="border border-gray-100 rounded-md p-3">
						<p class="font-mono text-xs text-gray-500">{group.wbs_id}</p>
						<p class="font-medium text-sm text-gray-900">{group.wbs_name}</p>
