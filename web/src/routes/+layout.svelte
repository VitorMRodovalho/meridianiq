<script lang="ts">
	...
	const navSections: NavSection[] = [
		...
		},
		{
			...
			items: [
				{ href: '/health', label: 'Health Score', icon: 'M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z' },
				{ href: '/alerts', label: 'Early Warning', icon: 'M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9' },
				...
				{ href: '/cost', label: 'Cost Integration', icon: 'M9 7h6m0 10v-3m-3 3v-6m-3 6v-1M5 3h14a2 2 0 012 2v14a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2z' },
			],
		},
		{
			title: 'Prediction & AI', auth: true,
			items: [
				{ href: '/ask', label: 'Ask Schedule', icon: 'M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z' },
				...
				{ href: '/pareto', label: 'Pareto Analysis', icon: 'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z' },
...
<div class="flex min-h-screen bg-gray-50 dark:bg-gray-950">
	...
	">
		...
		<div class="px-6 py-4 border-t border-gray-700">
			...
			<p class="text-xs text-gray-500 mt-0.5">v3.5.0</p>
		</div>
	</aside>
