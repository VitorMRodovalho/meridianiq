...
<div class="p-8 max-w-6xl mx-auto">
	<div class="mb-6 flex items-center justify-between">
		<div>
			...
			<h1 class="text-2xl font-bold text-gray-900 dark:text-gray-100">Sample Schedule Analysis</h1>
			<p class="text-sm text-gray-500 dark:text-gray-400 mt-1">This is a synthetic schedule demonstrating MeridianIQ's analysis capabilities.</p>
		</div>
		<a
			href="/login"
	...
	{:else if data}
		...
		<div class="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-8">
			...
			<div class="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg p-4 text-center">
				...
				<p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Calendars</p>
			</div>
			<div class="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg p-4 text-center">
				<p class="text-2xl font-bold text-gray-900 dark:text-gray-100">{data.project.wbs_count}</p>
				<p class="text-xs text-gray-500 dark:text-gray-400 mt-1">WBS Elements</p>
			</div>
		</div>
		...
		<div class="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg p-6 mb-8">
			<div class="flex items-center justify-between mb-4">
				<h2 class="text-lg font-semibold text-gray-900 dark:text-gray-100">DCMA 14-Point Assessment</h2>
				<div class="text-right">
					...
					<p class="text-xs text-gray-500 dark:text-gray-400">{data.validation.passed_count} passed / {data.validation.failed_count} failed</p>
				</div>
			</div>
		...
		<!-- Critical Path -->
		<div class="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg p-6 mb-8">
			<h2 class="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4">Critical Path ({data.critical_path.length} activities)</h2>
				...
				<table class="min-w-full divide-y divide-gray-200 text-sm">
					<thead class="bg-gray-50 dark:bg-gray-800">
						<tr>
							...
							<th class="px-4 py-2 text-right text-xs font-medium text-gray-500 dark:text-gray-400 uppercase">Total Float (days)</th>
						</tr>
					</thead>
