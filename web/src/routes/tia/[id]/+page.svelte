...
<div class="p-8 max-w-7xl mx-auto">
	...
	{:else if analysis}
		<div class="flex items-center justify-between mb-6">
			<div>
				<h1 class="text-2xl font-bold text-gray-900">TIA: {analysis.analysis_id}</h1>
		...
		<div class="grid grid-cols-4 gap-4 mb-6">
			<div class="bg-white border border-gray-200 rounded-lg p-4">
				<p class="text-xs text-gray-500 uppercase font-medium">Total Owner Delay</p>
				<p class="text-2xl font-bold text-blue-600 mt-1">
					{analysis.total_owner_delay.toFixed(1)}d
				</p>
			</div>
			<div class="bg-white border border-gray-200 rounded-lg p-4">
				<p class="text-xs text-gray-500 uppercase font-medium">Total Contractor Delay</p>
				<p class="text-2xl font-bold text-red-600 mt-1">
					{analysis.total_contractor_delay.toFixed(1)}d
				</p>
			</div>
			<div class="bg-white border border-gray-200 rounded-lg p-4">
				<p class="text-xs text-gray-500 uppercase font-medium">Total Shared Delay</p>
				<p class="text-2xl font-bold text-yellow-600 mt-1">
					{analysis.total_shared_delay.toFixed(1)}d
				</p>
			</div>
			<div class="bg-white border border-gray-200 rounded-lg p-4">
				<p class="text-xs text-gray-500 uppercase font-medium">Net Delay</p>
				<p
		...
		{#if waterfallData.length > 0}
			<div class="bg-white border border-gray-200 rounded-lg p-6 mb-6">
				<h2 class="text-lg font-semibold text-gray-900 mb-4">Delay by Responsibility</h2>
		...
		<div class="bg-white border border-gray-200 rounded-lg mb-6">
			<div class="px-6 py-4 border-b border-gray-200">
				<h2 class="text-lg font-semibold text-gray-900">Fragment Results</h2>
			</div>
					...
					<tbody class="divide-y divide-gray-200">
						{#each analysis.results as r}
							<tr class="hover:bg-gray-50">
								<td class="px-4 py-3">
									<span class="font-medium text-gray-900">{r.fragment_name}</span>
			...
			<div class="bg-white border border-gray-200 rounded-lg">
				<div class="px-6 py-4 border-b border-gray-200">
					<div class="flex items-center justify-between">
						<h2 class="text-lg font-semibold text-gray-900">Contract Compliance</h2>
						<div class="flex gap-3 text-xs">
							<span class="text-gray-500">{compliance.total_checks} checks</span>
						...
						<div class="px-6 py-4">
							<div class="flex items-start gap-3">
								...
								<div class="flex-1 min-w-0">
									...
									<p class="text-sm text-gray-600">{check.finding}</p>
